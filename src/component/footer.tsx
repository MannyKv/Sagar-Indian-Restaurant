                ...
                <Box className={classes.content_container}>
                    <Box style={{width: "fit-content", margin: "0 auto", flex: 1}}> {/* Parent container */}
                        ...
                        <Text size={"sm"} c={"white"}> {/* Center align the text */}
                            Since opening in 2000, we have been open operating 7 days a week providing a warm and
                            friendly space to eat and laugh with friends.
                            <br/><br/>Sagar Indian Restaurant aims to bring the taste of India to the North Shore. Our
                            experienced and professional chef is passionate about authentic Indian cuisine. You will
                            love our extensive and delicious menu!
