        ...
        <Box className={classes.background}>
            ...
            <Box className={classes.container}>
                ...
                <Text fz="sm" className={classes.description}>
                    At Sagar Indian Restaurant, we bring the authentic flavors of Indian cuisine to the North Shore. Our
                    extensive menu offers something for every taste, including a variety of delicious vegetarian
                    options.
                </Text>
